...
public class ControllerMenuFormation {
    ...
    @FXML private Label dishesLabel1;
    @FXML private Label dishesLabel2;
    @FXML private Label dishesLabel3;
    @FXML private Label dishesLabel4;
    @FXML private Label dishesLabel5;
    @FXML private Label dishesTitle;
    @FXML private Button exitButton;
    @FXML private Label expensesLabel;
    @FXML private Label expensesTitle;
    @FXML private Label heading;
    @FXML private Label menuLabel;
    @FXML private Label menuTitle;
    @FXML private Label personTitle;
    ...
    void initialize() {
        exitButton.setOnAction(actionEvent -> {
            openOtherWindow("/sample/layout/authorization.fxml");
        });
        recipesButton.setOnAction(actionEvent -> {
            openOtherWindow("/sample/layout/recipes.fxml");
        });
        storeButton.setOnAction(actionEvent -> {
            openOtherWindow("/sample/layout/store.fxml");
        });
